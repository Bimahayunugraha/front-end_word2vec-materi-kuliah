...
const CorpusListItem = ({ data }) => {
  return (
    <div className="flex flex-row items-center border-b border-gray-200 py-3 px-6 hover:bg-gray-50">
      <div className="mr-3 inline-flex max-w-[48px] items-center justify-center text-sm text-secondary-navy">
        <i className="fa-solid fa-folder"></i>
      </div>
      <div className="min-w-0 flex-1 flex-col items-center">
        <Link
          to={`/filelist/corpus/file/${data}`}
