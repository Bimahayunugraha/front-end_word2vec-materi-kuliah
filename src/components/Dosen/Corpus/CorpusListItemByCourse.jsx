...
import { deleteCorpus } from "../../../stores/features/corpusSlice";
...
const CorpusListItemByCourse = ({ data }) => {
  ...
  const handleDelete = (e) => {
    ...
    try {
      dispatch(deleteCorpus(id)).then(() => {
        mutate("corpus");
        mutate("course-materials");
      });
      ...
      setTimeout(
        () =>
          Toast.fire({
            icon: "success",
            title: "Data korpus berhasil dihapus",
          }),
        1000
      );
      ...
      setTimeout(
        () =>
          Toast.fire({
            icon: "error",
            title: "Data korpus gagal dihapus",
          }),
        1000
      );
      dispatch(setLoaderSubmit(false));
    ...
    <div>
      <div className="hidden flex-col border-b border-gray-200 py-3 px-6 hover:bg-gray-50 md:flex-row md:items-center lg:flex">
        ...
        <div className="min-w-0 flex-1 flex-col items-center">
          <Link
            to={`/filelist/corpus/file/${course}/${id}`}
      ...
      <div className="border-b border-gray-200 py-3 px-6 hover:bg-gray-50 lg:border-none lg:px-0 lg:py-0">
...
export default CorpusListItemByCourse;
