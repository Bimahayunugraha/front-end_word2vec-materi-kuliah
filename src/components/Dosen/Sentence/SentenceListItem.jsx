...
import { deleteSentence } from "../../../stores/features/sentenceSlice";
import { expiratedFile } from "../../../utils/expiratedFile";
import DangerModal from "../../DangerModal";

const SentenceListItem = ({ data }) => {
  ...
  const handleDownload = (id, name, mimetype) => {
      ...
      setTimeout(
        () =>
          Swal.fire({
            icon: "success",
            title: "Dihapus",
            text: "Data sentence berhasil dihapus",
            showConfirmButton: false,
            timer: 2000,
            background: "#ffffff",
          }),
      ...
      setTimeout(
        () =>
          Swal.fire({
            icon: "error",
            title: "Error",
            text: "Data sentence gagal dihapus",
            showConfirmButton: false,
            timer: 2000,
            background: "#ffffff",
          }),
